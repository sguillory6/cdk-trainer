...
class CdkTrainerStack(cdk.Stack):
    ...
    def __init__(self, scope: cdk.Construct, construct_id: str, **kwargs) -> None:
        ...
        with open(os.path.join(dirname, "../resolver_functions/create_trainer.txt"), 'r') as file:
        ...
        with open(os.path.join(dirname, "../resolver_functions/update_trainer.txt"), 'r') as file:
        ...
        with open(os.path.join(dirname, "../resolver_functions/delete_trainer.txt"), 'r') as file:
        ...
        with open(os.path.join(dirname, "../resolver_functions/all_trainers.txt"), 'r') as file:
        ...
        with open(os.path.join(dirname, "../resolver_functions/get_trainer.txt"), 'r') as file:
